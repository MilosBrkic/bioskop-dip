...
<div>
    ...
    <div class="container">
        <form:form action="${pageContext.request.contextPath}/film/${film.id}/save" method="post" modelAttribute="film">
            ...
            <spring:message code="url.placeholder" var="placeholder"/>
            <div class="form-group">    
                <label for="url"><fmt:message key="film.url" />:</label>
                <div><form:input type="text" class="form-control" id="url" path="url" placeholder="${placeholder}" maxlength="200"/></div>
                <div class="text-danger">
