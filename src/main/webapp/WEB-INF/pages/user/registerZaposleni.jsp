...
<div>
    ...
    <c:if test="${not empty error}">
        ...
        <form:form action="${pageContext.request.contextPath}/user/registerZaposleni" method="post" modelAttribute="korisnik">
            ...
            <p>
            <div><button id="save" class="btn btn-primary"><fmt:message key="register.zaposleni"/></button></div>
            </p>
        </form:form>
    </div>
</div>
