...
<script>
    function disableSeat(red, sediste, mine){
...
<div>
    ...
    <div class="container">     
        <form:form action="${pageContext.request.contextPath}/karta/buy" method="post" modelAttribute="korpa">    
        <div class="row">
            <div class="col-sm">
            ...
            <div class="col-sm"> 
                ...
                <div id="aypal-button-container"></div>

                <div id="success" class="alert alert-info" role="alert mb-2" hidden>Uspesna kupovina</div>

                <p>
                <div><button id="save" class="btn btn-primary"><fmt:message key="plati"/></button> </div>
                </p>
                <p>
        ...
        <button class="ml-3" disabled style="background-color: blue">_</button> <fmt:message key="vase"/>
